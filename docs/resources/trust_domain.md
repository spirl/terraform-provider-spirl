...
- `created_at` (String) An RFC3339 timestamp for when the trust domain was created by Terraform
...
- `updated_at` (String) An RFC3339 timestamp for when the trust domain was last updated by Terraform
