...
subcategory: ""
description: |-
  Creates a cluster for the given trust domain
---
...
- `created_at` (String) An RFC3339 timestamp for when the cluster was created by Terraform
- `id` (String) The unique identifier for the cluster
- `updated_at` (String) An RFC3339 timestamp for when the cluster was last updated by Terraform
